...
public class ConfigSettings {
    ...
    private static void defaults() {
        ...
        add(new ToggleSetting("Custom Supply Timer", "Custom Tick Based Supply Timer, also displays pearl throw timer", "Kuudra", "Supplies", false));
        ...
        add(new ToggleSetting("Fresh Alert", "Displays a title and alerts Party Chat when Fresh Tools Activates", "Kuudra", "", false));
